    ...
    <>
      ...
      <div className="projects">
        ...
        <div className="audiophile">
          ...
          <h4>SITE: <a href="https://audiophile-e-commerce-site.vercel.app/" target="blank">https://audiophile-e-commerce-site.vercel.app/</a></h4>
        ...
        <div className="space">
          ...
          <h3>STACK: React</h3>
          <h4>SITE: <a href="https://sage-mooncake-7f60eb.netlify.app/" target="blank">https://sage-mooncake-7f60eb.netlify.app/</a></h4>
        ...
        <div className="spotify">
          ...
          <h4>SITE: <a href="https://random-spotify-playlist-from-words.vercel.app/" target="blank">https://random-spotify-playlist-from-words.vercel.app/</a></h4>
